...
ENV PATH=/tools/verible/verible-v0.0-2135-gb534c1fe:/tools/verilator/4.210/bin/:/opt/conda/envs/core-v-mini-mcu/bin:/opt/conda/condabin:/tools/riscv/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
